...
Some supplemental materials for the workshop are contained within the [SPRING24-Git](https://github.com/perlsdiver/ITP-Labs/tree/main/Spring24-Git) folder, which I will update with feedback from workshop participants. One example is a [syllabus](https://github.com/perlsdiver/ITP-Labs/blob/main/Spring24-Git/Syllabus-Example.md) I converted from Microsoft Word to Markdown, then lightly edited.
